...
<body>
    <div class="registration">
        <div class="reg-wrapper">
            ...
            <div class="reg-body">
                <h4 style="text-align: center; margin-bottom: 25px;">Registration Form</h4>
                <form action="" class="form-inline" method="post">
                    ...
                    <div class="submit">
                        ...
                        <a href="index.php" class="text-right registered">Already registered?</a>
                    </div>
                </form>
            </div>
			<?php 
                if (isset($_POST["submit"])) {
                    ...
                    mysqli_query($link, "insert into users values('','$_POST[name]','$_POST[username]','$hashed_password','$_POST[email]','$_POST[phone]','$_POST[address]','$photo')");
                    ?>
