				...
				<div class="profile-content">
					<div class="row">
						<div class="col-md-3">
                            ...
                            <?php 
                                if (isset($_POST["submit"])) {
                                    ...
                                    mysqli_query($link, "UPDATE users SET photo='".$imagepath."' WHERE username='".$_SESSION['username']."'");
						...
						<div class="col-md-7 ml-30">
							<div class="details">
								<?php
                                   $res5 = mysqli_query($link, "SELECT * FROM users WHERE username='$_SESSION[username]' ");
